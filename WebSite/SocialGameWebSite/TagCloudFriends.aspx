<%@ Page Title="" Language="C#" MasterPageFile="~/FrontOffice.master" AutoEventWireup="true" CodeFile="TagCloudFriends.aspx.cs" Inherits="TagCloudFriends" %>
...
<asp:Content ID="Content4" ContentPlaceHolderID="MainContent" Runat="Server">
    <center>
            ...
            <script type="text/javascript">
                ...
                function GetUserFriendsTagsList_ajax() {
                    ...
                    $.ajax({
                        url: 'Ajax/GetFriendsTagList.aspx',
                        type: 'GET',
