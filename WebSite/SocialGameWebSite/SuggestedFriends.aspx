<%@ Page Title="" Language="C#" MasterPageFile="~/FrontOffice.master" AutoEventWireup="true" CodeFile="SuggestedFriends.aspx.cs" Inherits="SuggestedFriends" %>
...
<asp:Content ID="Content4" ContentPlaceHolderID="MainContent" runat="Server">
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
            <td class="cel_titulo">SuggestedFriends<p class="barra_titulo">&nbsp;</p>
            </td>
        </tr>
        <tr>
                    ...
                    <ContentTemplate>
                        ...
                        <asp:GridView ID="grdRanking" runat="server" AllowPaging="True"
                            ...
                            <Columns>
                                ...
                                <asp:HyperLinkField DataNavigateUrlFields="idUser" DataNavigateUrlFormatString="SendFriendshipRequest.aspx?usr={0}" DataTextField="texto" DataTextFormatString="{0}">
                                <ItemStyle Width="200px" />
                                </asp:HyperLinkField>
                            </Columns>
