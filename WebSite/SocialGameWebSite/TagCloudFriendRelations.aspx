<%@ Page Title="" Language="C#" MasterPageFile="~/FrontOffice.master" AutoEventWireup="true" CodeFile="TagCloudFriendRelations.aspx.cs" Inherits="TagCloudFriendRelations" %>
    ...
    <center>
            ...
            <script type="text/javascript">
                ...
                $(document).ready(function () {
                    ...
                    GetRelationFriendsTagsList_ajax();
                });
                ...
                function GetRelationFriendsTagsList_ajax() {
                    ...
                    $.ajax({
                        url: 'Ajax/GetRelationsFriendsTagList.aspx',
                        type: 'GET',
