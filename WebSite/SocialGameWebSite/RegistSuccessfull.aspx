<%@ Page Title="" Language="C#" MasterPageFile="~/FrontOffice.master" AutoEventWireup="true" CodeFile="RegistSuccessfull.aspx.cs" Inherits="RegistSuccessfull" %>
...
<asp:Content ID="Content4" ContentPlaceHolderID="MainContent" Runat="Server">
    <center>
        ...
        <br />
        <br />
        <p class="p_sucesso"><b>Obrigado pelo seu registo.</b></p>
        <p class="p_sucesso"><b>Pode neste momento fazer download e jogo e começar a jogar !</b></p>
        <p class="p_sucesso">&nbsp;</p>
        <p class="p_sucesso">&nbsp;</p>
        <br />
        <br />
        <br /><br />
        <a href="Default.aspx" class="link_voltar_menu_principal">Clique aqui para voltar à Página Principal</a>
        <br />
        <br />
        <br />
        <br />
